...
const login = async (req, res) => {
    ...
    // const userToken = { _id: foundUser._id, firstName: foundUser.firstName, lastName: foundUser.lastName, email: foundUser.email, user_id: foundUser.user_id, roles: foundUser.roles }
