...
const AdminUsers = () => {
    ...
    const { data:orders, isSuccess:ordersIsSuccess ,isLoading} = useGetAllOrdersQuery()

    const [updateUser, { isError, isSuccess: updateUserSuccess, data: updateUserData }] = useUpdateUserMutation()
    ...
    const actionBodyTemplate = (rowData) => {
        return (
            ...
            <React.Fragment>
                ...
                {/* <Button icon="pi pi-box" rounded outlined severity="danger" onClick={() => {}} /> */}
            </React.Fragment>
        );
    };
    ...
    const viewOrder = (rowData)=>
   {
    ...
    return (
        <div>
            ...
            <div className="card">
                <Toolbar className="mb-4" left={null} right={rightToolbarTemplate}></Toolbar>
